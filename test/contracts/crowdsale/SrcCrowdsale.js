...
contract('SrcCrowdsale', (accounts) => {
    ...
    const newDuration = 86400 * 30; // 30 days
    ...
    it.skip('should fail, because we try to trigger buyTokens with a too low investment', async () => {
    ...
    it('2nd should mint tokens for presale', async () => {
        const three                     = web3.toWei(3, 'ether');
        const five                      = web3.toWei(5, 'ether');
